    ...
    <el-tabs type="border-card">
      ...
      <template slot-scope="scope">
        ...
        <el-button
          size="mini"
          type="danger"
          @click="deleteScheds(scope.$index, scope.row.id)">Delete</el-button>
      </template>
    </el-table-column>
        </el-table>
      </el-tab-pane>
    ...
    printLoanDetails(obj) {
      var dd = {
        ...
        content: [
            ...
            columns: [
              ...
              },
              {
                ...
                text: [
                  ...
                  {text:" \n Mobile No: 09361224834/Tel.: 038-5120290",bold:true,fontSize: 10,},
                  {
                    text: "\n\n Loan Card",
                    bold: true,
                    fontSize: 12
                                ...
                                columns:[{
                                    width:250,
                                    fontSize: 9,
                                    text:[{text:`Fullname: `,bold:true},`${this.loan.member.lname}, ${this.loan.member.fname} ${this.loan.member.mname != null ? this.loan.member.mname:''}`]
                                },
                                {
                                    fontSize: 9,
                                    width:150,
                                    text:[{text:`Account No.: `,bold:true},`${this.loan.member.account_number}`]
                                },
                                {
                                    fontSize: 9,
                                    width:200,
                                    text:[{text:`Gender: `,bold:true},this.loan.member.gender]
                                }
                                ]
                            },
                            {
                                columns:[{
                                    fontSize: 9,
                                    width:250,
                                    text:[{text:`Payment Period: `,bold:true},this.payment_period]
                                },
                                {
                                    fontSize: 9,
                                    width:150,
                                    text:[{text:`Term(month): `,bold:true},this.loan.loan_period]
                                },
                                {
                                    fontSize: 9,
                                    width:200,
                                    text:[{text:`Interest Rate: `,bold:true},`${this.loan.interest_rate} %(${this.loan_types.find(e=>e.code == this.loan.loan_type).name})`]
                                }]
                            },
                            {
                                columns:[{
                                    fontSize: 9,
                                    width:250,
                                    text:[{text:`Principal Amount: `,bold:true},(this.loan.principal).toFixed(2)]
                                },
                                {
                                    fontSize: 9,
                                    width:150,
                                    text:[{text:`Interest Amount: `,bold:true},(this.loan.interest).toFixed(2)]
                                },
                                {
                                    fontSize: 9,
                                    width:150,
                                    text:[{text:`Loan Cycle: `,bold:true},this.loan.loan_cycle]
                                }
                                ]
                            },
                                  {
                            ...
                            {
                               margin: [0, 5, 0, 0],
                              text:'I acknowledge that the loan indicated in this contract was disburse as of '+this.loan.date_release+', and that I recieved the proceeds outline in the disclosure statement',
                              fontSize:9
                            },
                                  {
                                      margin: [0, 10, 0, 0],
                                columns:[{
                                    fontSize: 9,
                                    width:150,
                                    text:[{text:`Client Signature: `,bold:true},'_______________']
                                },
                                {
                                    fontSize: 9,
                                    width:150,
                                    text:[{text:`_________________ \n`,bold:true},'Disbursed by']
                                },
                                    {
                                    fontSize: 9,
                                    width:150,
                                    text:[{text:`______________________ \n`,bold:true},'Witness Signature']
                                },
                                    {
                                    fontSize: 9,
                                    width:150,
                  ...
                  
                            {
                                ...
                                table: {
                                  widths: [50,35, 35,40,40,50,50,50,50,50],
                                  body: [
                                    [
                                      { text: "Date", bold: true, style: "tableHeader" },
                                      { text: "Principal", bold: true, style: "tableHeader"},
                                   
                                      { text: "Interest",alignment:'center', bold: true,style: "tableHeader"},
                                        { text: "Total",alignment:'center', bold: true,style: "tableHeader"},
                                 { text: "Date paid",alignment:'center', bold: true,style: "tableHeader"},
                                   { text: "Amnt. Col.",alignment:'center', bold: true,style: "tableHeader"},
                                    { text: "Variance",alignment:'center', bold: true,style: "tableHeader"},
                                     { text: "Principal Bal.",alignment:'center', bold: true,style: "tableHeader"},
                                          { text: "Interest Bal.",alignment:'center', bold: true,style: "tableHeader"},
                                      { text: "Officer Sig.",alignment:'center', bold: true,style: "tableHeader"},
          ...
          //       bold: true,
          //       text: `${(
          //         this.calcTotprincipalPaid + this.caltotInterest
          //       ).toFixed(2)}`,
          //       fontSize: 9,
          //       alignment: "right",
          //       color: "red"
        ...
        defaultStyle: {
          // alignment: 'justify'
            ...
            this.loan.loanscheds.forEach(el => {
  ...
  computed: {
    ...
    caltotInterest() {
      ...
      if (this.loan.loan_type == 1) {
        ...
        if (bal >= interest) {
          //   console.log('diri')
          this.form.paid_interest = Math.round(
            (parseFloat(this.loan.principal) *
              parseFloat(this.loan.loan_period) *
              (parseFloat(this.loan.interest_rate) / 100)) /
              n
    ...
    calcTotprincipalPaid() {
      ...
      if (this.loan.loan_type == 1) {
        ...
        if (bal >= principal) {
          console.log("diri");
          this.form.paid_principal = Math.ceil(principal);
          //  return principal_monthly
        } else {
          this.form.paid_principal = Math.ceil(bal);
          //  return bal
  ...
  mounted() {
    axios
      ...
      .then(res => {
        ...
        this.payment_period = this.periods.find(e=>e.code == this.loan.payment_period).name
