...
methods: {
    save(){
        ...
        axios.put('/api/v1/members/'+this.$route.params.id+'/',this.form).then(res=>{
            console.log(res.data)
               this.$message.success('Update data successfully')
    ...
    axios.get('/api/v1/members/'+this.$route.params.id).then(res=>{
        this.form = res.data
    })
}
